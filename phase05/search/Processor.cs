...
namespace search
{
    public class Processor : ISearch
    {
        ...
        public Processor(IInvertedIndex hashInvertedIndex)
        {
            _hashInvertedIndex = hashInvertedIndex;
        }
        ...
        {
            return signWords.SelectMany(x => _hashInvertedIndex.GetDocsContain(x)).ToHashSet();
        }
    }
}